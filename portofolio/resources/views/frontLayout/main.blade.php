...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('frontTemplate') }}/lib/animate/animate.min.css" rel="stylesheet">
        <link href="{{ asset('frontTemplate') }}/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
        <link href="{{ asset('frontTemplate') }}/lib/lightbox/css/lightbox.min.css" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{ asset('frontTemplate') }}/css/style.css" rel="stylesheet">
    </head>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="51">
        ...
        <script src="{{ asset('frontTemplate') }}/lib/easing/easing.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/lib/wow/wow.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/lib/waypoints/waypoints.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/lib/typed/typed.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/lib/owlcarousel/owl.carousel.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/lib/isotope/isotope.pkgd.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/lib/lightbox/js/lightbox.min.js"></script>
        
        <!-- Contact Javascript File -->
        <script src="{{ asset('frontTemplate') }}/mail/jqBootstrapValidation.min.js"></script>
        <script src="{{ asset('frontTemplate') }}/mail/contact.js"></script>
